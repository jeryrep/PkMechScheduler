...
public class ScrapService : IScrapService
{
    ...
    public Task<IDocument> ScrapSchedule(string group) => BrowsingContext.New(_configuration).OpenAsync($"https://podzial.mech.pk.edu.pl/stacjonarne/html/plany/{group}");
}